...
To add items with your assets to Universe Inventory library, you need to define them in folder 
VirtualUniverse/bin/inventory. See that folder README file
