...
----- Setup -----
Linux: To build, in the main universe directory, run:
  ./runprebuild.sh
  nant

Windows: Run the prebuild.bat in the main universe directory and then
open the created solution and compile it.

pCampBot.exe will end up in the regular VirtualUniverse/bin folder
