...
namespace HttpServer.Sessions
{
    ...
    public class MemorySessionStore : IHttpSessionStore
    {
        ...
        private readonly NSimpleChain<IHttpSession> _unusedSessions = new NSimpleChain<IHttpSession>();
        ...
        public IHttpSession Create(string id)
        {
            ...
            lock (_unusedSessions)
            {
                ...
                if (_unusedSessions.Dequeue( out session ))
                {                    
                    if (session != null)
                    {
                        MemorySession memsession = session as MemorySession;
                        memsession.SetId(id);
                        return memsession;
                    }
                }
