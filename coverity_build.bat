...
Prebuild.exe /target vs2019 /targetframework v%framework% /conditionals ISWIN;NET_%framework%

echo Setting up for build
set FileName=Compile.bat
...
:found
    ...
    rem @echo %fpath%\msbuild universe.sln > compile.bat
	...
	echo %fpath%\msbuild Universe.sln %args% %cfg% > %FileName% /p:DefineConstants="ISWIN;NET_%framework%

	echo Let's do it...
	..\cov-analysis\bin\cov-build.exe --dir cov-int Compile.bat
